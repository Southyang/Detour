...
from env_stage2_nodiffusion import Environment
            ...
            if env.index == 0 and IF_TRAIN:
                ...
                if len(buff) > HORIZON - 1:
                    if IMPROVED:
                        ...
                        actor_loss, critic_loss, total_loss = ppo_update_stage2_improved(policy=policy, optimizer=optimizer, batch_size=BATCH_SIZE, memory=memory, filter_index=filter_index,
